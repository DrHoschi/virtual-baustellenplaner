...
export function createProjectWorkspaceNavigation({ rootEl, onNavigate } = {}) {
  ...
  function sync(panelId, moduleId) {
    ...
    // PROJECT_STATE_NONE ist Projektverwaltung/Create Flow und besitzt bewusst
    // keine Projektinhalt-Tabzeile. PROJECT_STATE_OPEN zeigt ausschließlich die
    // drei freigegebenen Projektinhalte Übersicht / Assets / Bibliotheken.
